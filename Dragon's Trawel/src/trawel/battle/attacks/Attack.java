 ...
 * @param Z - (String) Weapon name
	...
	*/
	...
	public enum Wound{//TODO: make sure the reworked wounds are fully in
		...
		MAJOR_BLEED("Cut Artery","Applies up to %1$d of a combined normal bleed and double bleed, expected total %2$d.","An artery is cut!"),
		I_BLEED("Internal Bleeding","Applies a stacking %1$d bleed, expected %2$d.","Their insides get crushed."),
