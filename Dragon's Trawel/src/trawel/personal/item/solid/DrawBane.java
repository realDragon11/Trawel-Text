...
public enum DrawBane {
	...
	GOLD("gold chunk","A shiny metal of great value. Bring it to a Merchant's Guild!",8,4,false),
	UNICORN_HORN("unicorn horn","An impressive magic horn hacked from a horse.",6,3,false),
	...
	KNOW_FRAG("knowledge fragment","Aetheric wisdom partially bound to a scrap of paper. Bring it to a library to study and absorb for feat point progress!",2,1,false),
