...
public class randomLists {
	...
	public static void init() {
		...
		muggerTypes = new SRPlainRandom("mugger","robber","thug","bandit","marauder","outlaw","desperado","cutthroat");
		...
		attackMisses = new SRPlainRandom("They miss!","The attack is dodged!","It's a miss!","It goes wide!","It's not even close!");
	...
	public static String attackMissFluff() {
		return attackMisses.next();
	}
