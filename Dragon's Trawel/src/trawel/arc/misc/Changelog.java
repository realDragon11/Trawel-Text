	...
	//b__X is in development, b_X is the actual release of that version
		...
		public static final String[][] changelog = new String[][] {
			...
			{"b_14",
				...
				//misc indicators
				"Node Features with bosses will display the type of boss until slain. Treasure Beaches will show the number of cleared sections over the number of unlocked sections. Added indicator options to reduce save, ASCII, and line separator spam for screen readers.",
				//records
				"Record feature added. After enabled for a character, it creates and updates a local text file with every action you take and every world thing you see. While intended as an alternative to video files for feedback, it is human readable and can be used by players wishing keep a personal record of their playthroughs. If you want to help with feedback, you can enable records and then upload these files to a host of your choosing.",
				//misc
				"Dock far-flung travel bypasses encounter chance but costs money. Misc typo fixes and attribute challenge balance tweaks."
			},
			{"b_13",
