...
public class WeaponAttackFactory {
	...
	public WeaponAttackFactory() {
		...
		martialStance = new Stance();
		tempAttack = new Attack("hack",.9,90.0,20,20,0,"X` hacks at Y` with their Z`!",1,"sharp");
		martialStance.addAttack(tempAttack);
		martialStance.addAttack(tempAttack);
		martialStance.addAttack(tempAttack);
		...
		martialStance = new Stance();
		tempAttack = new Attack("slash",1,60.0,20,2,0,"X` slashes at Y` with their Z`!",0,"sharp");
		martialStance.addAttack(tempAttack);
		martialStance.addAttack(tempAttack);
		martialStance.addAttack(tempAttack);
		tempAttack = new Attack("stab",1.1,60.0,1,1,12,"X` stabs at Y` with their Z`!",0,"pierce");
		martialStance.addAttack(tempAttack);
		martialStance.addAttack(tempAttack);
		tempAttack = new Attack("thrust",.4,60.0,1,2,20,"X` thrusts at Y` with their Z`!",1,"pierce");
		martialStance.addAttack(tempAttack);
		martialStance.addAttack(tempAttack);
