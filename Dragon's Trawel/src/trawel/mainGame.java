...
public class mainGame {
	...
	public static final String[] changelog = new String[] {
			...
			"b_10: {part 2/?} This punishment system can be seen in the 'Trapped Treasure Chambers' in Mines and Dungeons, which have their own small set of traps and mechanics for those that would seek to loot them.",
			"b_10: {part 3/?} Aether is now used entirely for buying/selling equipment. Drawbanes still use World Currency. Enchanters no longer let you sell aether. This changes are meant to make each currency serve a purpose and let them be more common without dealing with exchanging balancing problems.",
			"b_10: {part 4/?} Added Drudger, Fell, Monster, and Animal Cleanse Quests. Almost all targets will award progress if encountered in Node Explorations or other features as well, with some exceptions for mooks. Some fightable hunters now reward Amber when looted. Witch Huts have more Collect targets.",
			"b_10: {part 5/?} Vampires and some other Bumpers will appear less during the daytime. Bandits will prefer money, not just valuable metals. Removed most bumper level requirements, and updated wolf pack with player allies.",
			"b_10: {part 6/?} There are more Primal Deathcheater types, and TODO more cult types.",
			"b_10: {part 7/?} The first Node in Features will not have forced combat, and the first two layers will have less free loot and less obstacle fights.",
			"b_10: {part 8/?} log.txt has full stack trace. Updated tutorial's feature explanations and list of world perks. Mines now properly weight their contents. Graveyard's Nightvison behavior has been fixed. Connection failure message will only play once, after 10 seconds.",
			"b_10: {part 9/?} Graphical: Improved usage of color fail codes. Added indicator colors to damage in attack previews. At some point background time display stopped changing colors, it now works again. ",
