...
public class GroveNode implements java.io.Serializable{
	...
	private void generate(int size) {
		...
		case 4: name = extra.choose("rotting","decaying") + " " + (extra.chanceIn(1, 3) ? RaceFactory.randRace(Race.RaceType.HUMANOID) : "") + extra.choose("corpse","body"); interactString = "loot corpse";break;
